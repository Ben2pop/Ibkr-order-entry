...
import { faSyncAlt, faPlus, faPenToSquare } from '@fortawesome/free-solid-svg-icons';
        ...
        <tbody>
          {sortedData.length > 0 ? (
            sortedData.map((row) => {
              ...
              const rowStyle = pnl !== null ? (pnl > 0 ? { backgroundColor: '#d4edda' } : { backgroundColor: '#f8d7da' }) : {};
              return (
